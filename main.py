...
if __name__ == "__main__":
    ...
    source_data_filename = "data_decoding_test" # filepath to a .csv containing everything we need to generate resumes: names, genders, ethnicity, companies(tech, med, educ), associations, education fields.
    ...
    data_decoding = pd.read_csv(f"{source_data_filename}.csv") # the data of job offers
