...
if __name__ == "__main__":
    ...
    data_decoding = pd.read_csv(f"resume_generation/data/{source_data_filename}.csv") # the data of job offers
    data_desc = pd.read_csv("resume_generationdata/data_desc_test.csv")
