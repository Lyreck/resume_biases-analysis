...
if __name__ == "__main__":
    ...
    if generate_descriptions:
        ...
        resume_generation.generate_descriptions(source_data_filename, out_filename="data_desc_generated", model='mistral-small', tech=True, med=True, edu=True, asso=True)
        ...
        data_desc = pd.read_csv("scripts/resume_generation/data/data_desc_generated.csv")
