...
if __name__ == "__main__":
    ...
    resume_characteristics = sys.argv[1] # filepath to a .csv containing everything we need to generate resumes: names, genders, ethnicity, companies(tech, med, educ), associations, education fields.
