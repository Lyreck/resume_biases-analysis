...
def load_and_process_data_files():
    ...
    resume_database = pd.read_csv("data/database_all_cv_combinations_with_keys.csv")
    ...
    name_experiment_nurse_not_adapted = pd.read_csv("data/scores_experiments/name/Nurse_Freelance_Jehovah_switnesses.csv")
